...
var umbraTestRunner = require('@umbra-test/umbra-test-runner');
...
class ArgsParser {
    constructor() {
        this.argsParser = new argparse.ArgumentParser({
...
let finalConfig;
if (fs.existsSync(argConfig.configPath)) {
    ...
    if (path.extname(argConfig.configPath) === "ts") {
        ...
        child_process.spawnSync("tsc", ["--outFile", finalPath, argConfig.configPath], { stdio: "inherit" });
    }
...
const runner = new umbraTestRunner.TestRunner({
